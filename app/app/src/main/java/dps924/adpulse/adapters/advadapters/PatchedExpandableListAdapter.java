...
package dps924.adpulse.adapters.advadapters;
...
/**
 * Meant to replace the {@link android.widget.BaseExpandableListAdapter} as the starting point for building a
 * specialized adapter for the {@link android.widget.ExpandableListView}. It provides convenient capabilities
 ...
 * Activity recreation with {@link #onRestoreInstanceState(android.os.Parcelable)}.
 * <p/>
 * <b>Ownership:</b> This adapter will take ownership of an ExpandableListView's {@link
 * android.widget.ExpandableListView.OnGroupClickListener}, {@link android.widget.ExpandableListView.OnChildClickListener}, and
 * {@link android.widget.ExpandableListView.MultiChoiceModeListener}. Attempting to set those listeners directly
...
public abstract class PatchedExpandableListAdapter extends BaseExpandableListAdapter {
	...
	/** {@link java.lang.ref.WeakReference} to {@link android.widget.ExpandableListView} which the adapter is currently attached. */
	 ...
	 * {@link android.widget.ExpandableListView} is established.
	 */
	private Set<QueueAction> mQueueAction;

	/**
	 * Defines the various behaviors supported for use with {@link android.widget.ExpandableListView}. While
	 * similar to those found within {@link android.widget.AbsListView} they are not equivalent.
	 *
	 ...
	 * reference to it's {@link android.widget.ExpandableListView}. This may occur for various reasons since the
	...
	/**
	 * @return The current choice mode to be applied to the attached {@link android.widget.ExpandableListView}
	 */
	...
	/**
	 * Defines the choice behavior for the attached {@link android.widget.ExpandableListView}. By default, this
	 ...
	 * <p/>
	 * Use this method instead of {@link android.widget.ExpandableListView#setChoiceMode(int)}. This adapter will
	 ...
	 * group's children will be fetched using {@link #getChildView(android.view.LayoutInflater, int, int,
	 * boolean, android.view.View, android.view.ViewGroup) getChildView()}.
	 *
	 * @param inflater      The LayoutInflater object that can be used to inflate each view.
	 ...
	 * manage the lifecycle of the selection {@link android.view.ActionMode}. Only used when the choice mode is
	...
	/**
	 * Start an {@link android.view.ActionMode}. Use this method instead of {@link android.widget.ExpandableListView#startActionMode(android.view.ActionMode.Callback)
	 ...
	 * modal variants. It acts as the {@link android.view.ActionMode.Callback} for the selection mode and also
	...
	public static interface ChoiceModeListener extends ActionMode.Callback {
		 ...
		 * {@link #onChildCheckedStateChanged(android.view.ActionMode, int, long, int, long, boolean)
	...
	/**
	 * Handles reading from and writing to a {@link android.os.Parcel}.  The parcel is used for maintaining the
	...
	/**
	 * Wraps around the {@link android.widget.AbsListView.MultiChoiceModeListener} and converts it's item checked
