 ...
 * <p/>
 * The NFRolodexArrayAdapter uses a {@link java.util.Map} to organize the data under each group. The children
 * within each grouping are backed by an {@link java.util.ArrayList}. The data can be easily modified in
