...
/**
 * For use with an {@link android.widget.ExpandableListView}, The rolodex adapters are specifically designed to
 ...
 * <p/>
 * The RolodexArrayAdapter uses a {@link java.util.Map} to organize the data under each group. The children
 * within each grouping are backed by an {@link java.util.ArrayList}. The data can be easily modified and
...
public abstract class RolodexArrayAdapter<G, C> extends PatchedExpandableListAdapter implements
	...
	/**
	 * Convenience method which joins all {@link java.util.ArrayList} values of a {@link java.util.Map} into one giant
	 * ArrayList. Order of the newly generated list will match the iteration order of the Map.
	 *
	 * @param map {@link java.util.Map} which stores an {@link java.util.ArrayList} of values to be joined.
	 ...
	 * #clear()}, then {@link #addAll(java.util.Collection)} without having to worry about an extra {@link
	 ...
	 * to {@link #sortAllChildren(java.util.Comparator)}. This will not sort groups themselves.
	 *
	 ...
	 * passing null to {@link #sortGroup(int, java.util.Comparator)}. This will not sort groups themselves.
	 *
	 * @throws ClassCastException If the comparator is null and the stored children do not
	 *                                      implement {@code Comparable}, or if {@code compareTo}
	 *                                      throws for any pair of items.
	 */
