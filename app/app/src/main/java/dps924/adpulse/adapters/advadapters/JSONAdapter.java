...
/**
 * A custom abstract {@link android.widget.BaseAdapter} that is backed by a {@link org.json.JSONArray} of arbitrary objects.
...
public abstract class JSONAdapter extends BaseAdapter implements Filterable {
	 ...
	 *
	 * @throws org.json.JSONException If the value at position doesn't exit or cannot be coerced to a
	 *                       boolean.
	 */
	 ...
	 *
	 * @throws org.json.JSONException If the value at position doesn't exit or cannot be coerced to a int.
	 */
	 ...
	 *
	 * @throws org.json.JSONException If the value at position doesn't exit or cannot be coerced to a long.
	 */
